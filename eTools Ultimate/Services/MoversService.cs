...
namespace eTools_Ultimate.Services
{
    internal class MoversService
    {
        ...
        public void Save()
        {
            ...
            {
                writer.Write(Script.NumberToString(mover.Prop.DwId, DefinesService.Instance.ReversedMoverDefines));
                writer.Write("\t");
                writer.Write(string.IsNullOrWhiteSpace(mover.Prop.SzName) ? @"""" : mover.Prop.SzName);
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwAi, DefinesService.Instance.ReversedAiDefines));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwStr));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwSta));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwDex));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwInt));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwHR));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwER));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwRace));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwBelligerence, DefinesService.Instance.ReversedBelligerenceDefines));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwGender));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwLevel));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwFlightLevel));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwSize));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwClass, DefinesService.Instance.ReversedRankDefines));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.BIfParts));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.NChaotic));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwUseable));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwActionRadius));
                writer.Write("\t");
                writer.Write(Script.Int64ToString(mover.Prop.DwAtkMin));
                writer.Write("\t");
                writer.Write(Script.Int64ToString(mover.Prop.DwAtkMax));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwAtk1, DefinesService.Instance.ReversedItemDefines));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwAtk2, DefinesService.Instance.ReversedItemDefines));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwAtk3, DefinesService.Instance.ReversedItemDefines));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwAtk4, DefinesService.Instance.ReversedItemDefines));
                writer.Write("\t");
                writer.Write(Script.FloatToString(mover.Prop.FFrame));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwOrthograde));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwThrustRate));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwChestRate));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwHeadRate));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwArmRate));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwLegRate));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwAttackSpeed));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwReAttackDelay));
                writer.Write("\t");
                writer.Write(Script.Int64ToString(mover.Prop.DwAddHp));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwAddMp));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwNaturalArmor));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.NAbrasion));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.NHardness));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwAdjAtkDelay));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.EElementType));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.WElementAtk));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwHideLevel));
                writer.Write("\t");
                writer.Write(Script.FloatToString(mover.Prop.FSpeed));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwShelter));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwFlying));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwJumpIng));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwAirJump));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.BTaming));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwResisMgic));
                writer.Write("\t");
                writer.Write(Script.FloatToString(mover.Prop.NResistElecricity / 100f));
                writer.Write("\t");
                writer.Write(Script.FloatToString(mover.Prop.NResistFire / 100f));
                writer.Write("\t");
                writer.Write(Script.FloatToString(mover.Prop.NResistWind / 100f));
                writer.Write("\t");
                writer.Write(Script.FloatToString(mover.Prop.NResistWater / 100f));
                writer.Write("\t");
                writer.Write(Script.FloatToString(mover.Prop.NResistEarth / 100f));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwCash));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwSourceMaterial, DefinesService.Instance.ReversedItemDefines));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwMaterialAmount));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwCohesion));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwHoldingTime));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwCorrectionValue));
                writer.Write("\t");
                writer.Write(Script.Int64ToString(mover.Prop.NExpValue));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.NFxpValue));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.NBodyState));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwAddAbility));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.BKillable));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwVirtItem1, DefinesService.Instance.ReversedItemDefines));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwVirtItem2, DefinesService.Instance.ReversedVirtualTypeDefines));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwVirtItem3));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.BVirtType1));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.BVirtType2));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.BVirtType3));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwSndAtk1, DefinesService.Instance.ReversedSoundDefines));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwSndAtk2, DefinesService.Instance.ReversedSoundDefines));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwSndDie1, DefinesService.Instance.ReversedSoundDefines));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwSndDie2, DefinesService.Instance.ReversedSoundDefines));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwSndDmg1, DefinesService.Instance.ReversedSoundDefines));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwSndDmg2, DefinesService.Instance.ReversedSoundDefines));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwSndDmg3, DefinesService.Instance.ReversedSoundDefines));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwSndIdle1, DefinesService.Instance.ReversedSoundDefines));
                writer.Write("\t");
                writer.Write(Script.NumberToString(mover.Prop.DwSndIdle2, DefinesService.Instance.ReversedSoundDefines));
                writer.Write("\t");
                writer.Write(string.IsNullOrWhiteSpace(mover.Prop.SzComment) ? @"""" : mover.Prop.SzComment);

                if(Settings.Instance.ResourcesVersion >= 19)
                {
                    writer.Write("\t");
                    writer.Write(Script.NumberToString(mover.Prop.DwAreaColor, DefinesService.Instance.ReversedAreaDefines));
                    writer.Write("\t");
                    writer.Write(string.IsNullOrWhiteSpace(mover.Prop.SzNpcMark) ? "=" : mover.Prop.SzNpcMark);
                    writer.Write("\t");
                    writer.Write(Script.NumberToString(mover.Prop.DwMadrigalGiftPoint));
                }
                writer.Write("\r\n");
            }
        }
